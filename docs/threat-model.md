...
Project-specific acceptance focus: Verify requester/approver separation, scope and duration limits, expiry under failure, concurrent requests, denied flows, break-glass exclusions, session/audit correlation, and OWASP controls.
